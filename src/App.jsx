    ...
    <>
      <Router>
        <Routes>
          ...
          <Route exact path="/all-user" element={<AllUserPage />} />
          <Route exact path="/new-dashboard" element={<NewDashboardPage />} />
          <Route exact path="/operators" element={<OperatorsPage />} />

          <Route exact path="/food-setting/*" element={<SettingPage />} />
          <Route
            exact
          ...
          />
          <Route exact path="/owe-amount" element={<OweAmountPage />} />

          <Route exact path="/driver-setting" element={<DriverSettingPage />} />
          <Route exact path="/driver-list/*" element={<DriverListPage />} />
          <Route
            exact
          ...
          <Route exact path="/other-history" element={<OtherHistoryPage />} />
          <Route exact path="/faq" element={<FaqPage />} />

          <Route exact path="/inside-faq" element={<InsidefaqPage />} />
          <Route
            exact
